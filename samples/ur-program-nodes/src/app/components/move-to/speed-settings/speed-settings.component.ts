...
export class SpeedSettingsComponent implements OnChanges {
    ...
    speedUnit!: DerivedUnit<AngularSpeed | Speed>;
    accelerationUnit!: DerivedUnit<AngularAcceleration | Acceleration>;
