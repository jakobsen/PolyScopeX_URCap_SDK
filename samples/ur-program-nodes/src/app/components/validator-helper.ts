...
import { isValidSymbolName } from './symbol-name-validation';
 ...
 * }
 */
export function getVariableNameValidator(this: CommonProgramPresenterComponent, ownVarName?: string): InputValidator<string> {
 ...
 * }
 */
export function getFunctionNameValidator(
    this: CommonProgramPresenterComponent,
 ...
 * }
 */
export function getModuleNameValidator(this: CommonProgramPresenterComponent): InputValidator<string> {
    return async (name: string) => {
 ...
 * ...
 */
export function getDescriptionValidator(this: CommonProgramPresenterComponent): InputValidator<string> {
 ...
 * ...
 */
export function getStringValidator(this: CommonProgramPresenterComponent, maxLength?: number): InputValidator<string> {
 ...
 * ...
 */
export function getXTimesValidator(this: CommonProgramPresenterComponent, min?: number, minLength?: number): InputValidator<string> {
 ...
 * ...
 */
export function getExpressionValidator(
    this: CommonProgramPresenterComponent,
    minLength?: number,
    maxLength?: number,
): InputValidator<string> {
